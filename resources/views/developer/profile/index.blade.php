...
<div class="container-fluid px-4">
    ...
    <div class="col-md-9">
        <div id="Personal-Info" class="tabcontent">
                ...
                <div class="card-body">
                    <div class="row personal-info-row">
                        ...
                        <div class="col-md-4 text-end">
                            <form enctype="multipart/form-data" id="profile_picture_form" method="post" action="{{ route('developer.change-profile.picture') }}">
                            @csrf
            ...
            <form method="POST" action="{{ route('developer.profile.perform') }}">
                @csrf
        ...
        <div id="Change-password" class="tabcontent">
            <form method="POST" action="{{ route('developer.profile.change.password') }}">
            @csrf
