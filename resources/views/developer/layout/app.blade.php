...
<html lang="en">
  ...
  <body>
    <div class="container-fluid position-relative bg-white d-flex p-0">
      ...
      <div class="content">
        <!-- Navbar Start -->
        @include('developer.layout.navbar')
        <!-- Navbar End -->
        @yield('content')
        <div class="container-fluid pt-4 px-4 mb-5 main-footer">
          <div class="bg-footer rounded-top-5 p-3">
            <p class="fw-bold">Hire Spot</p>
            <div class="row">
                <div class="col-md-6 align-items-center align-middle">
                    <div class="d-flex align-items-center">
                        <img src="{{ asset('website/img/hire-spot-logo.png') }}" style="max-width: 10% !important;" class="img-fluid" alt="" />
                        <div class="ms-2">
                        <p class="m-0">© {{ date('Y') }} Developed by Hire Spot</p>
                        <p class="m-0">All right reserved</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 text-end">
                    <a href="https://www.linkedin.com/company/hire-spot/" class="text-decoration-none" ><img src="{{ asset('assets/img/footer-linkedin.svg') }}" class="img-fluid me-2" alt="linkedin"/></a>
