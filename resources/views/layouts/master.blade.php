...
<html lang="en">
  <head>
    ...
    <link
      rel="icon"
      href="{{ url('public/assets/img/kaiadmin/favicon.ico')}}"
      type="image/x-icon"
    />
    ...
    <link rel="stylesheet" href="{{ url('public/assets/css/plugins.min.css')}}" />
    <link rel="stylesheet" href="{{ url('public/assets/css/kaiadmin.min.css')}}" />
