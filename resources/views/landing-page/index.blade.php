...
@section('title')
<title>{{ $profile->first_name ?? ''}} {{ $profile->last_name ?? ''}} | Sr. Software Engineer at Zoom Digital</title>
@stop
@section('content')
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <p class="lead fw-light mb-4">My name is {{ $profile->first_name ?? ''}} {{ $profile->last_name ?? ''}} and I help brands grow.</p>
